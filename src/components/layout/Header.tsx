...
export function Header() {
  ...
  const navLinks = [
    ...
    { href: '/products?category=all-flash', label: '全快闪 NAS' },
    { href: '/products?category=switch', label: '网络交换机' },
    { href: '/products?category=router', label: '路由器' },
    { href: '/products?category=nvr-hardware', label: 'QVR 专用机' },
    { href: '/products?category=expansion', label: '扩展设备' },
