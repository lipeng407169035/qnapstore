...
const defaultData = {
  ...
  products: [
    { id: 'prod_1', sku: 'TS-264', name: 'TS-264 双槽 NAS', series: 'Turbo NAS', categoryId: 1, categorySlug: 'home-nas', categoryName: '家用 NAS', price: 2199, originalPrice: null, description: 'Intel Celeron N5105 四核心 2.0GHz，2.5GbE × 2，4K 硬件解码，适合家庭多媒体与个人备份', specs: { cpu: 'Intel Celeron N5105', ram: '4GB DDR4', bays: 2, network: '2.5GbE×2' }, badge: '新品', color: '#0d2a4a', rating: 4.7, reviews: 42, stock: 100 },
    { id: 'prod_2', sku: 'TS-464', name: 'TS-464 四槽 NAS', series: 'Turbo NAS', categoryId: 1, categorySlug: 'home-nas', categoryName: '家用 NAS', price: 4399, originalPrice: null, description: 'Intel N5095 四核心 2.0GHz，PCIe 插槽扩展，2.5GbE × 2，多槽家用首选', specs: { cpu: 'Intel N5095', ram: '8GB DDR4', bays: 4, network: '2.5GbE×2' }, badge: '热销', color: '#0d1a3d', rating: 4.8, reviews: 87, stock: 50 },
    { id: 'prod_3', sku: 'TS-233', name: 'TS-233 双槽 NAS', series: 'Turbo NAS', categoryId: 1, categorySlug: 'home-nas', categoryName: '家用 NAS', price: 1219, originalPrice: 1372, description: 'Realtek 四核心，1GbE，入门家用备份首选', specs: { cpu: 'Realtek RTD1619B', ram: '2GB DDR4', bays: 2, network: '1GbE×1' }, badge: '特价', color: '#2a1a0d', rating: 4.5, reviews: 33, stock: 200 },
    { id: 'prod_4', sku: 'TS-364', name: 'TS-364 三槽 NAS', series: 'Turbo NAS', categoryId: 1, categorySlug: 'home-nas', categoryName: '家用 NAS', price: 3299, originalPrice: null, description: 'Intel N5105，M.2 SSD 缓存加速', specs: { cpu: 'Intel N5105', ram: '8GB DDR4', bays: 3, network: '2.5GbE×2' }, badge: null, color: '#1a2a3a', rating: 4.6, reviews: 19, stock: 30 },
    { id: 'prod_5', sku: 'TS-873A', name: 'TS-873A 八槽 NAS', series: 'Turbo NAS', categoryId: 2, categorySlug: 'business-nas', categoryName: '企业 NAS', price: 9299, originalPrice: null, description: 'AMD Ryzen V1500B 四核心，PCIe Gen3', specs: { cpu: 'AMD Ryzen V1500B', ram: '8GB DDR4', bays: 8, network: '2.5GbE×2' }, badge: null, color: '#0d1a2a', rating: 4.9, reviews: 28, stock: 15 },
    { id: 'prod_6', sku: 'TS-673A', name: 'TS-673A 六槽 NAS', series: 'Turbo NAS', categoryId: 2, categorySlug: 'business-nas', categoryName: '企业 NAS', price: 6309, originalPrice: 7083, description: 'AMD Ryzen V1500B，6 槽大容量', specs: { cpu: 'AMD Ryzen V1500B', ram: '8GB DDR4', bays: 6, network: '2.5GbE×2' }, badge: '特价', color: '#1a0d2a', rating: 4.7, reviews: 41, stock: 20 },
    { id: 'prod_7', sku: 'TVS-h874', name: 'TVS-h874 八槽 NAS', series: 'TVS-h Series', categoryId: 2, categorySlug: 'business-nas', categoryName: '企业 NAS', price: 14383, originalPrice: null, description: 'Intel Core i5-12400，ZFS 数据保护', specs: { cpu: 'Intel Core i5-12400', ram: '32GB DDR4', bays: 8, network: '2.5GbE×2' }, badge: '旗舰', color: '#0d2a1a', rating: 5.0, reviews: 14, stock: 8 },
    { id: 'prod_8', sku: 'TS-1683XU-RP', name: 'TS-1683XU-RP 机架式', series: 'NAS 机架系列', categoryId: 3, categorySlug: 'rackmount-nas', categoryName: '机架式 NAS', price: 21683, originalPrice: null, description: 'Intel Xeon D，双电源，16 槽 2U', specs: { cpu: 'Intel Xeon D-1521', ram: '8GB DDR4 ECC', bays: 16, network: '10GbE×2' }, badge: null, color: '#0d0d1a', rating: 4.8, reviews: 7, stock: 5 },
    { id: 'prod_9', sku: 'TS-832PX', name: 'TS-832PX 机架式', series: 'NAS 机架系列', categoryId: 3, categorySlug: 'rackmount-nas', categoryName: '机架式 NAS', price: 8518, originalPrice: null, description: 'Annapurna Labs AL-324，10GbE × 2', specs: { cpu: 'AL-324', ram: '4GB DDR4', bays: 8, network: '10GbE×2+2.5GbE×4' }, badge: null, color: '#1a1a0d', rating: 4.6, reviews: 11, stock: 10 },
    { id: 'prod_10', sku: 'QSW-1105-5T', name: 'QSW-1105-5T 5口 2.5GbE', series: 'QSW 非管理型', categoryId: 4, categorySlug: 'switch', categoryName: '网络交换机', price: 662, originalPrice: null, description: '全口 2.5GbE，无风扇静音设计', specs: { ports: 5, speed: '2.5GbE', fan: '无风扇', managed: '否' }, badge: '热销', color: '#0d1a0d', rating: 4.8, reviews: 103, stock: 500 },
    { id: 'prod_11', sku: 'QSW-M408S', name: 'QSW-M408S 网管交换机', series: 'QSW-M 管理型', categoryId: 4, categorySlug: 'switch', categoryName: '网络交换机', price: 3142, originalPrice: null, description: '8 口 10GbE SFP+，4 口 1GbE RJ45', specs: { ports_sfp: 8, ports_rj45: 4, speed_sfp: '10GbE', managed: '是' }, badge: null, color: '#1a0d0d', rating: 4.7, reviews: 24, stock: 50 },
    { id: 'prod_12', sku: 'QSW-M2116P', name: 'QSW-M2116P PoE 交换机', series: 'QSW-M 管理型', categoryId: 4, categorySlug: 'switch', categoryName: '网络交换机', price: 4093, originalPrice: null, description: '16 口 2.5GbE PoE+，总 PoE 功率 370W', specs: { poe_ports: 16, uplink: 4, total_power: '370W', managed: '是' }, badge: null, color: '#0d1a1a', rating: 4.6, reviews: 18, stock: 30 },
    { id: 'prod_13', sku: 'UX-1200U-RP', name: 'UX-1200U-RP 12槽扩展', series: '扩展设备', categoryId: 5, categorySlug: 'expansion', categoryName: '扩展设备', price: 10620, originalPrice: null, description: '12 槽 SAS/SATA 扩展设备', specs: { bays: 12, interface: 'SAS/SATA', form: '2U' }, badge: null, color: '#1a1a2a', rating: 4.7, reviews: 5, stock: 10 },
    { id: 'prod_14', sku: 'QXG-10G1T', name: 'QXG-10G1T 10GbE 网卡', series: 'QXG 网络扩展', categoryId: 6, categorySlug: 'network-card', categoryName: '网络配件', price: 708, originalPrice: null, description: 'PCIe Gen3 x4，10GBASE-T RJ45', specs: { interface: 'PCIe Gen3 x4', speed: '10GbE', connector: 'RJ45' }, badge: null, color: '#2a1a1a', rating: 4.6, reviews: 56, stock: 200 },
    { id: 'prod_15', sku: 'QXG-25G2SF', name: 'QXG-25G2SF 双口 25GbE', series: 'QXG 网络扩展', categoryId: 6, categorySlug: 'network-card', categoryName: '网络配件', price: 2832, originalPrice: null, description: 'PCIe Gen4，双口 25GbE SFP28', specs: { interface: 'PCIe Gen4 x8', speed: '25GbE', ports: 2, connector: 'SFP28' }, badge: '新品', color: '#1a2a1a', rating: 4.8, reviews: 12, stock: 50 },
    { id: 'prod_16', sku: 'LIC-NVR-4CH', name: 'QVR Pro 4频道监控授权', series: '软件授权', categoryId: 7, categorySlug: 'software', categoryName: '软件授权', price: 708, originalPrice: null, description: 'QVR Pro NVR 软件 4 频道 IP 监控', specs: { channels: 4, type: '永久授权' }, badge: null, color: '#2a2a0d', rating: 4.5, reviews: 29, stock: 999 },
    { id: 'prod_17', sku: 'LIC-VJBOD-1Y', name: 'VJBOD Cloud 年费授权', series: '软件授权', categoryId: 7, categorySlug: 'software', categoryName: '软件授权', price: 398, originalPrice: null, description: '云存储挂载为 NAS 虚拟磁盘机', specs: { type: '年费订阅', period: '1年' }, badge: null, color: '#2a0d2a', rating: 4.4, reviews: 17, stock: 999 },
    { id: 'prod_18', sku: 'QEWS-2Y', name: '二年延长质保服务', series: '延长质保 QEWS', categoryId: 8, categorySlug: 'warranty', categoryName: '延长质保', price: 775, originalPrice: null, description: 'QNAP 原厂延长质保 2 年', specs: { period: '2年', type: '硬件' }, badge: null, color: '#0d2a2a', rating: 4.9, reviews: 63, stock: 999 },
    { id: 'prod_19', sku: 'RAM-8GDDR4', name: '8GB DDR4 ECC UDIMM', series: '原厂内存', categoryId: 9, categorySlug: 'memory', categoryName: '内存', price: 418, originalPrice: 487, description: 'QNAP 原厂认证 8GB DDR4-2666 ECC', specs: { capacity: '8GB', type: 'DDR4 ECC UDIMM', speed: '2666MHz' }, badge: '特价', color: '#1a1a3a', rating: 4.7, reviews: 38, stock: 300 },
    { id: 'prod_20', sku: 'RAM-16GDDR5', name: '16GB DDR5 UDIMM', series: '原厂内存', categoryId: 9, categorySlug: 'memory', categoryName: '内存', price: 772, originalPrice: null, description: 'QNAP 原厂 16GB DDR5-4800 UDIMM', specs: { capacity: '16GB', type: 'DDR5 UDIMM', speed: '4800MHz' }, badge: '新品', color: '#1a2a3a', rating: 4.8, reviews: 21, stock: 150 },
  ],
  categories: [
